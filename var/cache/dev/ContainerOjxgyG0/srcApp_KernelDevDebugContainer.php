...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2d93a = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer0052d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9232b = [
        
    ];

    public function getConnection()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getConnection', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getMetadataFactory', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getExpressionBuilder', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'beginTransaction', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getCache', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getCache();
    }

    public function transactional($func)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'transactional', array('func' => $func), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'wrapInTransaction', array('func' => $func), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'commit', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->commit();
    }

    public function rollback()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'rollback', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getClassMetadata', array('className' => $className), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'createQuery', array('dql' => $dql), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'createNamedQuery', array('name' => $name), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'createQueryBuilder', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'flush', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'clear', array('entityName' => $entityName), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->clear($entityName);
    }

    public function close()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'close', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->close();
    }

    public function persist($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'persist', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'remove', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'refresh', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'detach', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'merge', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getRepository', array('entityName' => $entityName), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'contains', array('entity' => $entity), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getEventManager', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getConfiguration', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'isOpen', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getUnitOfWork', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getProxyFactory', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'initializeObject', array('obj' => $obj), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'getFilters', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'isFiltersStateClean', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'hasFilters', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return $this->valueHolder2d93a->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer0052d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2d93a) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2d93a = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2d93a->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__get', ['name' => $name], $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        if (isset(self::$publicProperties9232b[$name])) {
            return $this->valueHolder2d93a->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2d93a;
    ...
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;
    ...
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__isset', array('name' => $name), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;
    ...
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__unset', array('name' => $name), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;
    ...
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__clone', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        $this->valueHolder2d93a = clone $this->valueHolder2d93a;
    }

    public function __sleep()
    {
        $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, '__sleep', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;

        return array('valueHolder2d93a');
    }
    ...
    {
        $this->initializer0052d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer0052d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer0052d && ($this->initializer0052d->__invoke($valueHolder2d93a, $this, 'initializeProxy', array(), $this->initializer0052d) || 1) && $this->valueHolder2d93a = $valueHolder2d93a;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2d93a;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2d93a;
    }
}
