...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('afQb6whSNX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ylPtEh7gGr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZhyLxLop8D', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z7ly2HtkZ5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tTWaQjZtxd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DBOgifZII6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P5bU+Qih7J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1ccfd = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf831e = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiese44de = [
        
    ];

    public function getConnection()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getConnection', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getMetadataFactory', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getExpressionBuilder', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'beginTransaction', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getCache', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'transactional', array('func' => $func), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'wrapInTransaction', array('func' => $func), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'commit', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->commit();
    }

    public function rollback()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'rollback', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getClassMetadata', array('className' => $className), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'createQuery', array('dql' => $dql), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'createNamedQuery', array('name' => $name), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'createQueryBuilder', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'flush', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'clear', array('entityName' => $entityName), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->clear($entityName);
    }

    public function close()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'close', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->close();
    }

    public function persist($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'persist', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'remove', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'refresh', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'detach', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'merge', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'contains', array('entity' => $entity), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getEventManager', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getConfiguration', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'isOpen', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getUnitOfWork', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getProxyFactory', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'initializeObject', array('obj' => $obj), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'getFilters', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'isFiltersStateClean', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'hasFilters', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return $this->valueHolder1ccfd->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf831e = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1ccfd) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1ccfd = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1ccfd->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__get', ['name' => $name], $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        if (isset(self::$publicPropertiese44de[$name])) {
            return $this->valueHolder1ccfd->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1ccfd;
    ...
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;
    ...
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__isset', array('name' => $name), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;
    ...
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__unset', array('name' => $name), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;
    ...
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__clone', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        $this->valueHolder1ccfd = clone $this->valueHolder1ccfd;
    }

    public function __sleep()
    {
        $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, '__sleep', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;

        return array('valueHolder1ccfd');
    }
    ...
    {
        $this->initializerf831e = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf831e;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf831e && ($this->initializerf831e->__invoke($valueHolder1ccfd, $this, 'initializeProxy', array(), $this->initializerf831e) || 1) && $this->valueHolder1ccfd = $valueHolder1ccfd;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1ccfd;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1ccfd;
    }
}
