...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4R+oJenhp9', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GIgvCl7ejU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mw5VvpbKmR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6oasYx6lL4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('obRnFNONQg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bRokIlkUlx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder52402 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerfa716 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0db03 = [
        
    ];

    public function getConnection()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getConnection', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getMetadataFactory', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getExpressionBuilder', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'beginTransaction', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getCache', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getCache();
    }

    public function transactional($func)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'transactional', array('func' => $func), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'wrapInTransaction', array('func' => $func), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'commit', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->commit();
    }

    public function rollback()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'rollback', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getClassMetadata', array('className' => $className), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'createQuery', array('dql' => $dql), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'createNamedQuery', array('name' => $name), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'createQueryBuilder', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'flush', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'clear', array('entityName' => $entityName), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->clear($entityName);
    }

    public function close()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'close', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->close();
    }

    public function persist($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'persist', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'remove', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'refresh', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'detach', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'merge', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getRepository', array('entityName' => $entityName), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'contains', array('entity' => $entity), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getEventManager', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getConfiguration', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'isOpen', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getUnitOfWork', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getProxyFactory', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'initializeObject', array('obj' => $obj), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'getFilters', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'isFiltersStateClean', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'hasFilters', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return $this->valueHolder52402->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerfa716 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder52402) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder52402 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder52402->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__get', ['name' => $name], $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        if (isset(self::$publicProperties0db03[$name])) {
            return $this->valueHolder52402->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder52402;
    ...
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;
    ...
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__isset', array('name' => $name), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;
    ...
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__unset', array('name' => $name), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;
    ...
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__clone', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        $this->valueHolder52402 = clone $this->valueHolder52402;
    }

    public function __sleep()
    {
        $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, '__sleep', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;

        return array('valueHolder52402');
    }
    ...
    {
        $this->initializerfa716 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerfa716;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerfa716 && ($this->initializerfa716->__invoke($valueHolder52402, $this, 'initializeProxy', array(), $this->initializerfa716) || 1) && $this->valueHolder52402 = $valueHolder52402;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder52402;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder52402;
    }
}
